...
//     isTyping: boolean; // Add this prop for the typing indicator
// }
...
//     onThemeChange,
//     currentThemeImage,
//     isTyping, // Destructure the new prop
// }) => {
...
//     const { startCall, isInCall } = useCall(); // Use the startCall from context
...
//                     }}
//                 />
//                 <div className="flex flex-col justify-center"> {/* Added a div to stack name and typing indicator */}
//                     <h2 className="text-sm md:text-xl font-semibold text-gray-800 flex-1">
//                         {chatUser.name || chatUser.username}
//                     </h2>
//                     {isTyping && ( // Conditionally render typing indicator
...
//                     title="Audio Call"
//                     className={`p-2 rounded-full ${isInCall ? 'cursor-not-allowed opacity-50' : 'hover:bg-gray-100'} text-blue-600`}
//                 >
//                     <Phone size={20} />
//                 </button>
//                 <button
...
//                                             className={`flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left ${currentThemeImage === theme.imageUrl ? 'bg-blue-100 font-semibold' : ''
//                                                 }`}
//                                         >
//                                             {theme.name}
//                                         </button>
