...
interface ChatListProps {
    ...
    onSelectChat: (selectedUser: GeneralUser) => void;
    currentSelectedChatUser?: GeneralUser | null; // To highlight the active chat
}
...
const ChatList: React.FC<ChatListProps> = ({
    ...
    const fetchConversations = useCallback(async () => {
        ...
        try {
            ...
            // Fetch details for any participants not already in the main chatUsers list
            // For now, we'll fetch followers/following directly as per your requirement
            // In a more complex app, you might fetch these directly from `/users/many` or a dedicated endpoint.
