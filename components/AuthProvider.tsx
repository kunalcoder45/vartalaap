...
//     mongoUserId?: string; // Add if you link Firebase user to a MongoDB user
//     name?: string; // Add if you store a custom name
//     avatarUrl?: string; // Add if you store a custom avatar URL
//     // ... any other custom fields you add to your user object
// }
