...
// import { ThumbsUp, MessageSquare, Share2, Smile, Edit, Trash2, MoreVertical } from 'lucide-react'; // Icons
// import Skeleton from 'react-loading-skeleton'; // For loading state UI
// import 'react-loading-skeleton/dist/skeleton.css'; // Skeleton CSS
// import { useState } from 'react';
// import CommentModal from './CommentModal'; // Assuming you have this component for comments
...
// /**
//  * PostCard component: Displays a single social media post.
//  * It shows author info, post text, media (image/video), and interaction buttons.
//  */
// const PostCard = ({
//     post,
//     handleLike,
...
//     onPostUpdated,
// }: {
//     post?: any; // Optional post data for loading state
//     handleLike: (postId: string, currentLikes: number, currentIsLiked: boolean) => Promise<void>;
//     handleShare: (postId: string) => Promise<void>;
//     loading: boolean; // Indicates if the card is in a loading state
//     currentUser: any; // Firebase user object
//     getIdToken: () => Promise<string | null>; // Function to get auth token
//     onPostDeleted: (postId: string) => void; // Function to call when a post is deleted
//     onPostUpdated: (updatedPost: any) => void; // Function to call when a post is updated
// }) => {
...
//         ? (post.author.avatarUrl.startsWith('http') ? post.author.avatarUrl : `${BACKEND_URL}${post.author.avatarUrl}`)
//         : `${BACKEND_URL}/avatars/userLogo.png`;
...
//     const currentUserAvatarUrl = currentUser?.photoURL
//         ? (currentUser.photoURL.startsWith('http') ? currentUser.photoURL : `${BACKEND_URL}/avatars/userLogo.png`)
//         : `${BACKEND_URL}/avatars/userLogo.png`;
...
//         setShowDeleteConfirmModal(true); // Open the custom confirmation modal
//         setShowOptionsDropdown(false); // Close the dropdown menu
//     };
...
//             onPostDeleted(post._id); // Call the parent callback to update the UI
...
//                                 </button>
//                                 <button
//                                     onClick={confirmDeleteHandler} // Changed to open custom modal
...
//                                 priority
//                             />
//                             <div className="relative w-full" style={{ paddingBottom: post.mediaType === 'image' ? '75%' : '56.25%' }}></div>
//                         </>
//                     ) : (
//                         <video
//                             src={postMediaFullUrl}
