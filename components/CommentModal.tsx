...
const CommentModal = ({
    ...
    return (
        <div className="fixed inset-0 z-100 top-15 flex items-center justify-center bg-opacity-30 backdrop-blur-sm p-4 transition-opacity duration-300 ease-out animate-scale-in">
