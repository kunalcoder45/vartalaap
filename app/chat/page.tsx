...
//           <div
//             className={`fixed inset-0 mt-14 z-40 bg-black/30 backdrop-blur-sm md:hidden transition-opacity duration-300 ${leftOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
//               }`}
//           >
//             <div
//               ref={leftRef}
...
//         {/* Main layout */}
//         <div className="h-full p-4 bg-gray-50 mt-18"> {/* Added h-full */}
//           <div className="flex h-full">
//             {/* Desktop Sidebar */}
//             <div className="hidden md:block w-3/12 h-full"> {/* Added h-full */}
//               <Slidebar joinedGroups={joinedGroups} currentPath={pathname} className="h-full" />
//             </div>

//             {/* Chat Main Component */}
//             <main className="flex-1 overflow-hidden p-0 h-full rounded-lg">
//               <Main userId={userIdToUse} />
//             </main>
//           </div>
//           <Toaster />
